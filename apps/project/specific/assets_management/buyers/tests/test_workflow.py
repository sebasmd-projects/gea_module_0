# apps/project/specific/assets_management/buyers/tests/test_workflow.py
"""
...
puede haber una orden que diga "pagada" sin los sellos que lo respalden.
    ...
    manage.py test apps.project.specific.assets_management.buyers.tests.test_workflow \\
...
from .test_buyers import OfferFixtureMixin
