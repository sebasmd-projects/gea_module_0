...
| ☐ | `REDIS_URL` puesta | Sin ella la caché es por proceso, y **todos los límites de intentos se multiplican por el número de workers** |
...
### 3. Restricción única que no existía en producción · ALTO · corregido
...
### 4. Subidas públicas sin validar · ALTO · corregido
...
### 5. Ejecución por shell innecesaria · MEDIO · corregido
...
### 6. Ajustes de sesión implícitos · MEDIO · corregido
